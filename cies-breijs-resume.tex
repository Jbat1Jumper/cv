...
\inlineheadsection  % special section that has an inline header with a 'hanging' paragraph
  {Con experiencia en:}
  {Programación en C/C++, Haxe, Haskell y Java. \LaTeX. Desarrollo de juegos en Construct2, Unity y Godot Engine. Desarrollo de frontend web en HTML5, CSS, y frameworks web en Javascript. Bases de datos MySql/SqlServer y MongoDb.}
